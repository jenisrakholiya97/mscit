    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', minHeight: 'calc(100vh - 120px)' }}>
      ...
      <div style={{
        ...
        <button
          ...
          className={`btn btn-sm ${activeMobileTab === 'catalog' ? 'btn-primary' : 'btn-secondary'}`}
        ...
        <button
          ...
          className={`btn btn-sm ${activeMobileTab === 'cart' ? 'btn-primary' : 'btn-secondary'}`}
          style={{ flex: 1, justifyContent: 'center' }}
        >
      ...
      <div style={{
        ...
        <div className="glass-panel" style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h2 style={{ fontSize: '1.25rem', fontWeight: 800 }}>POS Terminal</h2>
          ...
          <div style={{
            ...
            {loading ? (
              ...
              filteredProducts.map(p => (
                ...
                >
                  <div>
                    <span style={{ fontSize: '0.65rem', color: 'var(--accent-primary)', fontWeight: 700, textTransform: 'uppercase' }}>
                      {p.category_name || 'General'}
                    </span>
                    <h4 style={{ fontSize: '0.88rem', fontWeight: 700, margin: '0.2rem 0', color: 'var(--text-main)' }}>
                      {p.name}
                    </h4>
                  </div>
        ...
        <div className="glass-panel" style={{ padding: '1.25rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <div style={{ maxHeight: '250px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: '1rem' }}>
              {cart.length === 0 ? (
                <div style={{ textAlign: 'center', color: 'var(--text-muted)', padding: '2rem', fontSize: '0.85rem' }}>
                  Cart is empty. Click products to add to bill.
                </div>
              ) : (
                cart.map(item => (
                  <div key={item.product_id} style={{
                    ...
                    <div style={{ fontWeight: 700, fontSize: '0.88rem', width: '60px', textAlign: 'right' }}>
          ...
          <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '1rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.2rem', background: 'var(--bg-primary)', padding: '0.75rem', borderRadius: '10px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '1.15rem', fontWeight: 800, color: 'var(--text-main)', marginTop: '0.2rem' }}>
            ...
            <button 
              ...
              style={{ width: '100%', justifyContent: 'center', height: '44px', fontSize: '0.95rem' }}
